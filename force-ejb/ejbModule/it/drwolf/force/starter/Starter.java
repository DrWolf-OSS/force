...
public class Starter {
	...
	public void start() {
		...
		/*
		 * this.heartbeat.startFetcher(now.getTime(), new Long(24 * 60 * 60 *
		 * 1000), endDate.getTime()); now.add(Calendar.MINUTE, 10);
		 * this.heartbeat.avcpFetcher(now.getTime(), new Long(24 * 60 * 60 *
		 * 1000), endDate.getTime()); now.add(Calendar.MINUTE, 1);
